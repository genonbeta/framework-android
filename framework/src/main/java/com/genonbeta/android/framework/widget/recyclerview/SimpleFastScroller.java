...
public class SimpleFastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener
{
    ...
    public SimpleFastScroller(RecyclerView recyclerView, StateListDrawable verticalThumbDrawable,
